#line 1 "/home/ubuntu/proj/ei-projects/esp32-examples/ei-mbed-qcbor-http-acc/src/blynk/Settings.h"
...
#elif defined(USE_ESP32_VOC)
  #define BOARD_BUTTON_PIN            14                     // Pin where user button is attached
